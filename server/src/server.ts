		...
		const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
			...
			body: JSON.stringify({
				...
				messages: [
					{
						role: "system",
						content: "You are a code generator for DevSync. Return ONLY code in markdown format with appropriate language syntax. No explanations.",
					},
					{
						role: "user",
						content: prompt,
