...
import VersionView from "@/components/sidebar/sidebar-views/VersionView"
import useWindowDimensions from "@/hooks/useWindowDimensions"
import { VIEWS, ViewContext as ViewContextType } from "@/types/view"
import { ReactNode, createContext, useContext, useState } from "react"
import { IoSettingsOutline } from "react-icons/io5"
import { LuFiles, LuSparkles, LuClock } from "react-icons/lu"
...
function ViewContextProvider({ children }: { children: ReactNode }) {
    ...
    const [viewIcons] = useState({
        ...
        [VIEWS.VERSIONS]: <LuClock size={28} />,
    })
